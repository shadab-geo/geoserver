...
import org.geoserver.generatedgeometries.strategy.wkb.WkbGeometryGenerationStrategy.WkbConfiguration;
...
public class WkbGeometryConfigurationPanel extends Panel {
    ...
    private void initComponents(IModel model) {
        ...
        addAjaxTrigger(geometryAttributeNameTextField, wkbAttributeDropDown, declaredCRS);
    }
    ...
    WkbConfiguration getWkbConfiguration() {
        ...
        return new WkbConfiguration(
                geometryAttributeName, selectWkbGeometryAttribute.getName(), declaredCRS.getCRS());
    }
